...
namespace Intel8080.Emulator
{
    public class Flags
    {
        ...
        public bool Sign { get => GetFlag(SignMask); private set => SetFlag(value, SignMask); }
        public bool Zero { get => GetFlag(ZeroMask); private set => SetFlag(value, ZeroMask); }
        public bool AuxiliaryCarry { get => GetFlag(AuxCarryMask); private set => SetFlag(value, AuxCarryMask); }
        public bool Parity { get => GetFlag(ParityMask); private set => SetFlag(value, ParityMask); }
        public bool Carry { get => GetFlag(CarryMask); private set => SetFlag(value, CarryMask); }
        ...
        public void CalcAuxCarryFlag(byte value)
        {
            AuxiliaryCarry = (value & 0xF0) > 0x0F;
        }
